...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_TASKRESULT']._serialized_end=516
  _globals['_COORDINATOR']._serialized_start=519
  _globals['_COORDINATOR']._serialized_end=732
